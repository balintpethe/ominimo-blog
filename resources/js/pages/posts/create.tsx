            ...
            <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                ...
                <div className="mb-8 px-4 sm:px-0">
                    ...
                    <p className="mt-2 text-gray-600">
                        Oszd meg gondolataidat a világgal. A bejegyzés azonnal
                        láthatóvá válik.
                    </p>
                </div>
                        ...
                        <form onSubmit={submit} className="space-y-8">
                            ...
                            <div>
                                ...
                                {errors.title ? (
                                    ...
                                    <p className="mt-2 text-sm text-gray-500">
                                        Adj egy rövid, figyelemfelkeltő címet.
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="flex items-center justify-end gap-4 border-t border-gray-100 pt-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    {processing ? (
                                        <>
                                            <svg
